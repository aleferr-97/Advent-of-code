...
def findCalories(file):
    readersupp = open(file, 'r')
    n = len(readersupp.readlines())
    readersupp.close()
...
if __name__ == "__main__":
    ...
    print("Maximum calories: " + str(max(calories)))
    calories.sort(reverse=True)
    print("Top 3 summed: " + str(calories[0] + calories[1] + calories[2]))